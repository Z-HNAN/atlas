...
### Requirement: Sub-app load failure shows error page
The parent container SHALL display an error page when a sub-app fails to load.

#### Scenario: Load failure
- **WHEN** a sub-app fails to load or initialize
- **THEN** the parent container shows an error page indicating the failure
